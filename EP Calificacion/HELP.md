...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Spring for GraphQL'. As a
...
```
$ docker run --rm -p 8080:8080 EPCalificacion:0.0.1-SNAPSHOT
```
